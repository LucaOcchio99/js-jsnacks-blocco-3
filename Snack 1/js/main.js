...
{
   codice_giocatore : cifre_random(100, 899) + generateRandomString(3),
   nome_giocatore : 'Francesco',
   cognome_giocatore : 'Cozzoli',
   eta_giocatore : '33',
   media_punti : cifre_random(0, 50),
   successo_tiri : cifre_random(0, 100),
},
...
{
   codice_giocatore : cifre_random(100, 899) + generateRandomString(3),
   nome_giocatore : 'Domenico',
   cognome_giocatore : 'Occhionigro',
   eta_giocatore : '31',
   media_punti : cifre_random(0, 50),
   successo_tiri : cifre_random(0, 100),
},
...
const punti_maggiori = dieci_giocatori.filter((giocatore) => {
  ...
  return giocatore.media_punti > 35 && giocatore.successo_tiri > 80
});
